...
; Generated by Chris on 07.05.2022 (UTC)
;
[Setup]
AppID={{882cdfc3-ef4a-41c4-b56f-769c925b855e}
AppName=ASCOM ASCOM Fritzbox DECT Switch Switch Driver
AppVerName=ASCOM ASCOM Fritzbox DECT Switch Switch Driver 1.0
AppVersion=1.0
AppPublisher=Chris <Chriswie@a-city.de>
AppPublisherURL=mailto:Chriswie@a-city.de
...
OutputDir="."
OutputBaseFilename="ASCOM Fritzbox DECT Switch Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\ASCOM Fritzbox DECT Switch"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\ASCOM Fritzbox DECT Switch"
...
[Files]
Source: "C:\Users\Chris\source\repos\AscomDriverFritzboxSwitch\bin\Release\ASCOM.fb.Switch.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\Chris\source\repos\AscomDriverFritzboxSwitch\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
; Optional source files (COM and .NET aware)
Source: "C:\Users\Chris\source\repos\AscomDriverFritzboxSwitch\*"; Excludes: *.zip,*.exe,*.dll, \bin\*, \obj\*; DestDir: "{app}\Source\ASCOM Fritzbox DECT Switch Driver"; Tasks: source; Flags: recursesubdirs
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.fb.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.fb.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.fb.Switch.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.fb.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.fb.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
